...
#TODO: Create code chunks to better delineate different functions
#TODO: Add comments to communicate purpose of functions
#TODO: Create separate .py file for creating visualization inputs (e.g. scale for onset figure)
